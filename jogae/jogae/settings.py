"""
Django settings for jogae project.
...
SECRET_KEY = 'django-insecure-hs78gvh^soj&*ajigw(#d-876gsu=__=#-yl+t$*m0z!wpiaul'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app_profile.context_processors.friends_list', 
            ],
        },
    },
]

WSGI_APPLICATION = 'jogae.wsgi.application'
